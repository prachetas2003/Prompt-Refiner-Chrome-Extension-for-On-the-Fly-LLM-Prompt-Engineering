// src/background/llmProxy.ts
var SYSTEM = `You are Prompt\u2011Refiner, an AI assistant that rewrites vague or generic user requests into highly specific, detailed, and actionable prompts for large language models (LLMs).
...
function buildGeminiPayload(original) {
  return {
